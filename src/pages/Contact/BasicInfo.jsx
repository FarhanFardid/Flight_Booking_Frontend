const BasicInfo = () => {
  return (
    <>
      <div className="flex flex-col md:flex-row gap-3 md:gap-5 justify-evenly mb-8 pt-5 md:pt-16  p-2 md:p-8 items-center">
        <div className="text-center bg-slate-200 p-2 md:p-5 rounded-lg">
          <h2 className="text-base md:text-2xl font-semibold py-2 md:py-3 text-blue-700">
            Our Address
          </h2>
          <div className="text-xs md:text-base font-medium text-black">
            <p>QuickFly</p>
            <p>221-B, Brent St.</p>
            <p>London,UK.</p>
          </div>
